import {
  Col_default
} from "./chunk-YR6WIWFX.js";
import {
  FormCheckInput_default
} from "./chunk-OLWFYJMU.js";
import {
  FloatingLabel_default,
  FormGroup_default
} from "./chunk-ALRDPYUF.js";
import {
  FormContext_default
} from "./chunk-QM5H6OQX.js";
import {
  require_classnames,
  useBootstrapPrefix
} from "./chunk-R6MCNLXQ.js";
import {
  require_jsx_runtime
...
var FormLabel = React7.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = "label",
  bsPrefix,
  column = false,
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime8.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
  ...
  return (
    ...
    (0, import_jsx_runtime8.jsx)(Component, {
      ref,
      className: classes,
      htmlFor,
      ...props
...
var FormRange = React8.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React9.forwardRef(({
  bsPrefix,
  size,
  htmlSize,
  className,
  ...
  return (0, import_jsx_runtime10.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
...
var FormText = React10.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React11.forwardRef((props, ref) => (0, import_jsx_runtime12.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Form = React12.forwardRef(({
  ...
  as: Component = "form",
  ...props
}, ref) => (0, import_jsx_runtime13.jsx)(Component, {
  ...props,
  ref,
  className: (0, import_classnames10.default)(className, validated && "was-validated")
}));
